...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Courses and Workshops\CS50\ubuntu\Final Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Courses and Workshops\CS50\ubuntu\Final Project\venv\Scripts\deactivate.nu'
